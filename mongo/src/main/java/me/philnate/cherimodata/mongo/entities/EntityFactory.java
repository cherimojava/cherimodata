...
import me.philnate.cherimodata.mongo.io.EntityCodec;

import static com.google.common.base.Preconditions.checkNotNull;
import static me.philnate.cherimodata.mongo.entities.annotations.IndexField.Ordering.ASC;
		...
		if (c != null && c.indexes() != null) {
			for (Index index : c.indexes()) {
				...
				for (IndexField field : index.value()) {
					...
					indxBuilder.addKey(field.field(), (field.order() == ASC) ? OrderBy.ASC : OrderBy.DESC);
				}
