 ...
 *
 * @param <F> Entity this computer is getting as input
 * @param <T> Type of the value this computer computes
 * @author philnate
 * @since 1.0.0
 */
public interface Computer<F extends Entity, T>
{
     ...
     *
     * @param f Entity instance for which the property of type T is computed
