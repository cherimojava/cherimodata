...
public interface Entity<T extends Entity>
{
     ...
     *         not)
     * @throws IllegalStateException if no MongoDB instance is linked to this Entity
     */
    public boolean save();
     ...
     *
     * @param property name of property to read (Naming as it will be used within MongoDB)
     * @return value of the property or null if the value isn't present.
     * @throws IllegalArgumentException if the property isn't declared for that entity
     */
     ...
     *
     * @param property name of property to write (Naming as it will be used within MongoDB)
     ...
     * such entity exists
     *
     * @param id which identifies the Entity to load. Corresponds to the _id field
     ...
     * content is equal
     *
     * @param o object to compare this entity with
