...
import static me.philnate.cherimodata.mongo.CommonInterfaces.PrimitiveEntity;
...
public class _EntityPropertyFactory extends TestBase {
	...
	public void collectionName() {
		...
		assertEquals("Nested", factory.create(CommonInterfaces.NestedEntity.class).getCollectionName());
	}
	...
	public void explicitIdDetection() {
		...
		assertTrue(factory.create(CommonInterfaces.ExplicitIdEntity.class).hasExplicitId());
		assertTrue(factory.create(CommonInterfaces.ImplicitIdEntity.class).hasExplicitId());
	}
