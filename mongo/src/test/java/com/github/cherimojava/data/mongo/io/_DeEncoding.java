    ...
    extends MongoBase
{
    ...
    public void basicDeEncodingDB()
    {
        ...
        Document doc = db.getCollection( getCollectionName( PrimitiveEntity.class ) ).find( new Document() ).limit( 1 )
            .iterator().next();
    ...
    public void noDuplicateIdWritten()
    {
        ...
        EntityCodec<ExplicitIdEntity> codec =
            new EntityCodec<>( db, EntityFactory.getProperties( ExplicitIdEntity.class ) );
    ...
    public void computedStoredCorrectly()
    {
        ...
        Document doc = db.getCollection( getCollectionName( ComputedPropertyEntity.class ) ).find( new Document() )
            .limit( 1 ).iterator().next();
        assertJson( sameJSONAs( "{ \"string\":\"some\", \"Integer\":1, \"computed\":\"some1\"}" )
            .allowingExtraUnexpectedFields(), doc );
    ...
    public void explicitIdBasicDeEncodingDB()
    {
        ...
        Document doc = db.getCollection( getCollectionName( ExplicitIdEntity.class ) ).find( new Document() ).limit( 1 )
            .iterator().next();
    ...
    public void transientPropertyDeEncodingDB()
    {
        ...
        Document doc = db.getCollection( getCollectionName( TransientEntity.class ) )
            .find( new Document( "_id", "some" ) ).limit( 1 ).iterator().next();
    ...
    {
        PrimitiveEntity pe =
            factory.readEntity( PrimitiveEntity.class, "{\"string\":\"some\",\"Integer\":1,\"unknown\":\"dontfail\"}" );
    ...
    @Test
    public void finalIsFinalAfterSave()
    ...
    private static interface ThingOne
        extends Entity<ThingOne>
    {
        @Reference
    ...
    private static interface ThingTwo
        extends Entity<ThingTwo>
    {
        @Reference
    ...
    private static interface AutoboxedEntity
        extends Entity<AutoboxedEntity>
    {
        @Final
    ...
    private static interface TransientEntity
        extends Entity
    {
        @Transient
    ...
    private interface Listed
        extends Entity<Listed>
    {
    ...
    private interface DateTimeEntity
        extends Entity<DateTimeEntity>
    {
        public String getId();
    ...
    {
        return db.getCollection( getCollectionName( clazz ) ).withDocumentClass( clazz )
            .withCodecRegistry( EntityCodecProvider.createCodecRegistry( db, clazz ) );
    }

    private interface RecursiveEntity
        extends Entity<RecursiveEntity>
    {
