    ...
    extends TestBase
{
     ...
     */
    @Test
    public void validMethodNameResolution()
    ...
    @Test
    public void pojoNameNotChangedByNameAnnotation()
        throws NoSuchMethodException
    {
     ...
     */
    @Test
    public void invalidMethodNameResolution()
        throws NoSuchMethodException
    {
        try
        {
     ...
     */
    @Test
    public void nameAnnotationForId()
        throws NoSuchMethodException
    {
        try
        {
     ...
     */
    @Test
    public void idAndNameAnnotationInvalid()
        throws NoSuchMethodException
    {
        try
        {
     ...
     */
    @Test
    public void mongoNameResolution()
        throws NoSuchMethodException
    {
     ...
     */
    @Test
    public void isAssignableFromClass()
        throws NoSuchMethodException
    {
        assertTrue( EntityUtils
            .isAssignableFromClass( PrimitiveEntity.class.getDeclaredMethod( "setInteger", Integer.class ) ) );
        assertFalse(
            EntityUtils.isAssignableFromClass( NestedEntity.class.getDeclaredMethod( "setString", String.class ) ) );
    }
    ...
    private static interface IdNameTest
        extends Entity<IdNameTest>
    {
        @Named( "_id" )
