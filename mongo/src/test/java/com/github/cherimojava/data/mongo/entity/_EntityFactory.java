    ...
    extends TestBase
{
    ...
    public void fromJSON()
    {
        CommonInterfaces.PrimitiveEntity pe =
            factory.readEntity( CommonInterfaces.PrimitiveEntity.class, "{\"string\": \"something\",\"Integer\":3}" );
    ...
    private abstract class AbstractNoPubList
        extends NoPubList
    {
