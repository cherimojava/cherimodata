...
public class _ParameterPropertyBuilder
    extends TestBase
{
    ...
    @Test
    public void detectFluent()
        throws NoSuchMethodException
    {
        assertFalse( Builder.buildFrom( FluentEntity.class.getMethod( "getNotFluent" ), validator )
            .isFluent( ParameterProperty.MethodType.SETTER ) );
        assertTrue( Builder.buildFrom( FluentEntity.class.getMethod( "getOwnClass" ), validator )
            .isFluent( ParameterProperty.MethodType.SETTER ) );
        assertTrue( Builder.buildFrom( FluentEntity.class.getMethod( "getSuperClass" ), validator )
            .isFluent( ParameterProperty.MethodType.SETTER ) );
    }
        ...
        throws NoSuchMethodException
    {
        assertEquals( String.class,
            Builder.buildFrom( FluentEntity.class.getMethod( "getNotFluent" ), validator ).getType() );
        ...
        assertEquals( Integer.class,
            Builder.buildFrom( CommonInterfaces.PrimitiveTypeEntity.class.getDeclaredMethod( "getInt" ), validator )
                .getType() );
    }

    @Test
    public void detectContainedType()
        throws NoSuchMethodException
    {
        try
        {
        ...
        assertFalse(
            Builder.buildFrom( PrimitiveEntity.class.getDeclaredMethod( "getInteger" ), validator ).isCollection() );
    }

    @Test
    public void retrieveMongoName()
        throws NoSuchMethodException
    {
    ...
    @Test
    public void detectIdAnnotation()
        throws NoSuchMethodException
    {
    ...
    {
        assertTrue(
            Builder.buildFrom( PrimitiveEntity.class.getDeclaredMethod( "getString" ), validator ).hasConstraints() );
        assertFalse(
            Builder.buildFrom( PrimitiveEntity.class.getDeclaredMethod( "getInteger" ), validator ).hasConstraints() );
    }
    ...
    {
        assertTrue(
            Builder.buildFrom( FluentEntity.class.getDeclaredMethod( "getNotFluent" ), validator ).isTransient() );
        assertFalse(
            Builder.buildFrom( FluentEntity.class.getDeclaredMethod( "getOwnClass" ), validator ).isTransient() );
    }
    ...
    @Test
    public void referenceTypeDetection()
        throws NoSuchMethodException
    {
        assertTrue(
            Builder.buildFrom( ReferencingEntity.class.getDeclaredMethod( "getPE" ), validator ).isReference() );
        assertTrue(
            Builder.buildFrom( LazyLoadingEntity.class.getDeclaredMethod( "getPE" ), validator ).isReference() );
        assertTrue(
            Builder.buildFrom( LazyLoadingEntity.class.getDeclaredMethod( "getPE" ), validator ).isLazyLoaded() );
    ...
    @Test
    public void referenceDBRefDetection()
        throws NoSuchMethodException
    {
    ...
    @Test
    public void referenceOnlyOnEntities()
        throws NoSuchMethodException
    {
        try
        {
    ...
    private static interface FinalTypes
        extends Entity
    {
        @Final
    ...
    private static interface ComputedEntity
        extends Entity
    {
    ...
    public static class StringComputer
        implements Computer<Entity, String>
    {
        @Override
    ...
    public static interface ReferencedEntity
        extends Entity
    {
        @Reference
    ...
    public static interface InvalidReference
        extends Entity
    {
        @Reference
